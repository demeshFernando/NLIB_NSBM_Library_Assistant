      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            UnderlineContainer(),
            bodyContainer(
              'One of the basic credential we are checking here is the Username for Sign In. In here the user can enter his/her index number which was reserved by the university.',
            ),
            SizedBox(height: Dimentions.height5),
            WelcomeNoteImage(
            ...
            UnderlineContainer(),
            bodyContainer(
              'Since the Index  Number and the Password is created by the university itself for you since you registered to the university, the application itself does not have permission to reset the username or password. which is reserved for you. If you believe that your password is leaked you can lock the application by visiting to the library or sending a mail to the library staff. Even you can get library details using the application though the mail does not fix any thing instantly it will be a proof to say that from now onward the actions you are doing using the application is not authorized by you.',
            ),
            const SizedBox(
